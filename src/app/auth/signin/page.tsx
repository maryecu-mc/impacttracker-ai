  ...
  return (
    <div className="max-w-sm mx-auto pt-16">
      <div className="text-center mb-8">
        ...
        <p className="text-sm text-slate-500">Save your accomplishments across devices.</p>
      </div>
      ...
      <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm space-y-4">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 border border-slate-300 rounded-lg px-4 py-3 text-sm font-medium text-slate-700 hover:bg-slate-50 transition-colors disabled:opacity-50"
        >
